...
name is a strong greedy. The decision actually in front of me gets a deeper correction:
`four_pick_lookahead` searches target sequences across my next four held picks, and
`rollout` re-scores the finalists for every first-pick candidate over the whole
remaining draft with noisy, roster-aware opponents.
