...
def my_next_picks(
    ...
    what the player adds to my expected lineup now after the soft roster-depth preference,
    and the similarly adjusted expected value of the best player still there at my
    following pick if I take him.
